...
<form id="writeForm" method="post" action="/reboard/write">
  ...
  <table>
    <tr>
      <td colspan="5">
        <input name="subject" id="subject" type="text" value="${article.subject}" placeholder="제목">
    ...
    <tr>
       <td id="btn-td">
          <button type="button" class="btn btn-success btn-default" id="submitBtn">수정</button>
...
function writeArticle(){
  if(document.querySelector('input[name="subject"]').value == ""){
    ...
    document.querySelector('#writeForm').action = "/reboard/modify";
    document.querySelector('#writeForm').method = "post"
